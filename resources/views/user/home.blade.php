                                    ...
                                    <tbody>
                                       ...
                                       @foreach ($mahasiswas as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->angkatan }}</td>
                                            <td>
                                                <a href="{{ url('user/' . $item->id) }}" title="Lihat Detail"><button style="padding: 15px" class="btn btn-primary btn-md"><i class="fa fa-eye" aria-hidden="true"></i> Lihat Detail</button></a>
                                                {{-- <a href="invoice-print.html" target="_blank" class="btn btn-info" style="padding: 15px"><i class="fa fa-print"></i> Print</a> --}}
                                                <a href="{{ url('user/' . $item->id . '/print' ) }}" target="_blank" title="Lihat Detail"><button style="padding: 15px" class="btn btn-warning btn-md"><i class="fa fa-eye" aria-hidden="true"></i> Print</button></a>
                                            </td>
                                        </tr>
                                       @endforeach
...
{{-- <div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-9">
            <div class="card">
                <div class="card-header"><h4><strong>Selamat datang, {{$user->name}}</strong> anda melakukan login sebagai {{ $user->role }}</h4> </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                            ...
                            @foreach($mahasiswas as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->angkatan }}</td>
                                    <td>
                                        <a href="{{ url('user/' . $item->id) }}" title="Lihat Detail"><button style="padding: 15px" class="btn btn-primary btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Lihat Detail</button></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
