              ...
              <div class="col-md-9">
                  ...
                  <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <form action="{{ url('admin/' .$mahasiswas->id) }}" method="post">
                          {!! csrf_field() !!}
                          @method("PATCH")
                          <input type="hidden" name="id" id="id" value="{{$mahasiswas->id}}" id="id" />
                          <label>NIM</label></br>
                          <input type="text" name="nim" id="name" value="{{$mahasiswas->nim}}" class="form-control"></br>
                          <label>Nama</label></br>
                          <input type="text" name="nama_lengkap" id="address" value="{{$mahasiswas->nama_lengkap}}" class="form-control"></br>
                          <label>Prodi</label></br>
                          <input type="text" name="prodi" id="mobile" value="{{$mahasiswas->prodi}}" class="form-control"></br>
                          <label>Angkatan</label></br>
                          <input type="text" name="angkatan" id="mobile" value="{{$mahasiswas->angkatan}}" class="form-control"></br>
                          <center><input type="submit" style="padding: 15px" value="Update" class="btn btn-success"></br></center>
                        </form>
...
{{-- <div class="card">
  ...
  <div class="card-body">
      ...
      <form action="{{ url('admin/update/' .$mahasiswas->id) }}" method="get">
        {!! csrf_field() !!}
        @method("get")
        <label>NIM</label></br>
        <input type="text" name="name" id="name" value="{{$mahasiswas->nim}}" class="form-control"></br>
        <label>Nama</label></br>
        <input type="text" name="address" id="address" value="{{$mahasiswas->nama_lengkap}}" class="form-control"></br>
        <label>Prodi</label></br>
        <input type="text" name="mobile" id="mobile" value="{{$mahasiswas->prodi}}" class="form-control"></br>
        <label>Angkatan</label></br>
        <input type="text" name="mobile" id="mobile" value="{{$mahasiswas->angkatan}}" class="form-control"></br>
